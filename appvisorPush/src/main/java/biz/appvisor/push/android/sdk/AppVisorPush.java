	...
	static class AppVisorPushSender extends Handler
    {
        ...
        public boolean sendToServer(boolean isInService)
        {
            ...
            try
            {
        		...
        		String connectType		= AppVisorPushUtil.getConnection( this.appContext );
                ...
                else
                {
						...
						try
						{
							...
							if( properties != null )
							{
								for(Iterator<String> it = properties.keys();it.hasNext();)
								{
									...
									SharedPreferences.Editor editor = this.appContext.getSharedPreferences(AppVisorPushSetting.SHARED_PREFERENCES_KEY ,Context.MODE_PRIVATE).edit();
            		...
            		{
            			AppVisorPushUtil.saveAppStatus( this.appContext , AppVisorPushSetting.APP_STATUS_KEY_OK );
            		...
            		else
            		{
            			...
            			{
            				AppVisorPushUtil.saveAppStatus( this.appContext , AppVisorPushSetting.APP_STATUS_KEY_KL );
        ...
        public boolean synchronizeUserProperties()
        {
            ...
            try
            {
            	...
            	List<String> specialPropertyList = (List<String>) AppVisorPush.sharedInstance().getUserPropertyWithGroup(this.appContext, AppVisorPush.SpecialUserPropertyGroup1);;
            	int sizeOfList = specialPropertyList.size();
